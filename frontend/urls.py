...
urlpatterns = [
    ...
    # whatsapp:
    path("whatsapp_conf/",whatsapp_conf,name="whatsapp_conf"),
    path("whatsapp-logs/", whatsapp_logs_page, name="whatsapp_logs_page"),
    path("payments/<str:payment_id>/invoice-pdf/", generate_invoice_pdf, name="generate_invoice_pdf"),
